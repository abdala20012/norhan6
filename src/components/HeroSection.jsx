...
export default function HeroSection() {
  ...
  return (
    <section className="hero-section">
      ...
      >
        <div className="hero-profile-ring">
          <div className="hero-profile-photo">
            {!failed ? (
              <img src={src} alt="نورهان" onError={onError} loading="eager" />
            ) : (
      ...
      <motion.div
        className="hero-date hero-special-date"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1, delay: 1.3 }}
      >
        يوم مميز في حياتنا: 12 / 7 / 2026 ✦
      </motion.div>
      ...
      >
        من يوم 7/12/2025 والدنيا شكلها اتغيّر قدام عنيا <span className="inline-heart">♥</span><br /><br />
