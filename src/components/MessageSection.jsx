    ...
    <section className="message-section">
      ...
      >
        ...
        <h2 className="message-title">
          ...
          <span className="signature">نورهان ❤️</span>
        </h2>
        ...
        >
          ...
          من 12/10/2025 وأنا كل شوية باكتشف حاجة جديدة تخليني أحبك أكتر.
        ...
        >
          بحبك يا نورهان بجد، وربنا يخليكي ليا ويفضل يضحكك طول عمرك ❤️🌹
        </motion.p>
      </motion.div>
    </section>
  )
